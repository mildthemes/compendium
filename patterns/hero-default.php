 ...
 * Categories: compendium-heroes
 * Keywords: hero
 */
?>
<!-- wp:group {"metadata":{"name":"Hero","categories":["compendium-heroes"],"patternName":"compendium/hero-default"},"style":{"spacing":{"blockGap":"var:preset|spacing|small","margin":{"top":"32px","bottom":"64px"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="margin-top:32px;margin-bottom:64px"><!-- wp:heading {"textAlign":"left","level":1,"style":{"typography":{"fontStyle":"normal","fontWeight":"500","letterSpacing":"-0.5px","lineHeight":"1.65"},"elements":{"link":{"color":{"text":"var:preset|color|secondary"}}}},"textColor":"secondary","fontSize":"large"} -->
